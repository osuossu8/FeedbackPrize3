...
if CFG.save:
    ...
    MODEL_NM = 'roberta-base' # 'microsoft/deberta-base'
    ...
    MODEL_NM = 'roberta-large' # 'microsoft/deberta-v3-large'
    ...
    MODEL_NM = 'microsoft/deberta-v3-small' # 'microsoft/deberta-large-mnli'
    ...
    MODEL_NM = 'xlm-roberta-large' # 'microsoft/deberta-xlarge'
    ...
    MODEL_NM = 'deepset/deberta-v3-large-squad2' # 'microsoft/deberta-xlarge'
    #MODEL_NM = '../input/huggingface-deberta-variants/deberta-xlarge/deberta-xlarge'
    all_train_text_feats6, te_text_feats6 = get_embeddings(MODEL_NM, MAX=512)
    to_pickle(OUTPUT_DIR+f'{MODEL_NM.replace("/", "-")}_train_text_feats.pkl', all_train_text_feats6)

else:
    MODEL_NM = 'roberta-base' # 'microsoft/deberta-base' # MODEL_NM = 'microsoft/deberta-base'
    all_train_text_feats = unpickle(OUTPUT_DIR+f'{MODEL_NM.replace("/", "-")}_train_text_feats.pkl')

    MODEL_NM = 'roberta-large' # MODEL_NM = 'microsoft/deberta-v3-large'
    all_train_text_feats2 = unpickle(OUTPUT_DIR+f'{MODEL_NM.replace("/", "-")}_train_text_feats.pkl')

    MODEL_NM = 'microsoft/deberta-v3-xsmall' # MODEL_NM = 'microsoft/deberta-large'
    all_train_text_feats3 = unpickle(OUTPUT_DIR+f'{MODEL_NM.replace("/", "-")}_train_text_feats.pkl')

    MODEL_NM = 'microsoft/deberta-v3-small' # MODEL_NM = 'microsoft/deberta-large-mnli'
    all_train_text_feats4 = unpickle(OUTPUT_DIR+f'{MODEL_NM.replace("/", "-")}_train_text_feats.pkl')

    MODEL_NM = 'xlm-roberta-large' # MODEL_NM = 'microsoft/deberta-xlarge'
    all_train_text_feats5 = unpickle(OUTPUT_DIR+f'{MODEL_NM.replace("/", "-")}_train_text_feats.pkl')

    MODEL_NM = 'deepset/deberta-v3-large-squad2' # MODEL_NM = 'microsoft/deberta-xlarge'
    all_train_text_feats6 = unpickle(OUTPUT_DIR+f'{MODEL_NM.replace("/", "-")}_train_text_feats.pkl')
...
all_train_text_feats = np.concatenate([all_train_text_feats,all_train_text_feats2,
                                       ...
                                       all_train_text_feats5,all_train_text_feats6],axis=1)

if CFG.save:
    te_text_feats = np.concatenate([te_text_feats,te_text_feats2,
                                    te_text_feats3,te_text_feats4,
                                    te_text_feats5,te_text_feats6],axis=1)
