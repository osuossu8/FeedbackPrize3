...
class CFG:
    EXP_ID = '023'
    apex = True
    model = 'microsoft/deberta-v2-xlarge' # 'allenai/longformer-base-4096' # 'microsoft/deberta-xlarge' # 'microsoft/deberta-v3-large'  # 'microsoft/deberta-v3-base'
    seed = 2022 # 42 # 71
    n_splits = 5
    max_len = 1024 # 1429 # 1536 # 512
    dropout = 0
